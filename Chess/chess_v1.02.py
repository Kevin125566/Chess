...
class Game:
            ...
            for tile in row:
                if tile.pressed(mousePos): 
                    ...
                    if self.tile == self.otherTile:
                        self.tile = None
                        self.otherTile = None
                    if self.tile != None and self.otherTile != None and self.rules():
    ...
    def rules(self):
        ...
        indexOther = self.index_2d(self.otherTile)
...
class Piece:
    def __init__(self, rank, color):
        pieces = {  'BRook': 'r', 'BKnight': 'k', 'BBishop': 'b', 'BQueen': 'q', 'BKing': 'k', 'BPawn': 'p',
                    'WRook': 'R', 'WKnight': 'K', 'WBishop': 'B', 'WQueen': 'Q', 'WKing': 'K', 'WPawn': 'P', 'Blank': 0}
